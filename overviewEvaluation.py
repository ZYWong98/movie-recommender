...
from OverviewRecommendation import get_recommendations 
...
relevant_movies = pd.Series([" star wars: episode iii - revenge of the sith", "the empire strikes back", "return of the jedi"], name='movie')
